...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_pred')) {
        Object.defineProperty(Module['ready'], '_pred', { configurable: true, get: function() { abort('You are getting _pred on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_pred', { configurable: true, set: function() { abort('You are setting _pred on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _pred = Module["_pred"] = createExportWrapper("pred");
